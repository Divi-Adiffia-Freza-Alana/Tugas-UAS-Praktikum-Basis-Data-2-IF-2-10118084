...
if(@$_SESSION['admin'] || @$_SESSION['akademik']){
?>
<!doctype html>
<html lang="en">
<head>
	<title>Welcome | Akademik</title>
	<meta charset="utf-8">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<?php
								...
								} else if(@$_SESSION['akademik']) {
									$user_terlogin = @$_SESSION['akademik'];
								}
								// koneksi database
								$koneksi = mysqli_connect('localhost','root','','10118084_akademik');
								$sql_user = mysqli_query($koneksi, "SELECT * FROM t_user WHERE id_user = '$user_terlogin'") or die (mysqli_error());
		...
		<div id="sidebar-nav" class="sidebar">
            ...
            if(@$_SESSION['admin'] || @$_SESSION['akademik'] ){ ?>
             ...
             <?php
              ...
              <?php
              if(@$_SESSION['admin'] ||  @$_SESSION['akademik'] ){ ?>
						  <li><a href="?page=pengguna" class=""><i class="lnr lnr-users"></i> <span>Petugas</span></a></li>
            <?php
             }?>
             <?php
             if(@$_SESSION['admin'] || @$_SESSION['akademik'] ){ ?>
            ...
            <?php
             ...
             <?php
             if(@$_SESSION['admin'] ||  @$_SESSION['akademik'] ){ ?>
           <li><a href="?page=jurusan" class=""><i class="lnr lnr-map-marker"></i> <span>Jurusan</span></a></li>
            <?php
             }?>
             <?php
             if(@$_SESSION['admin'] ||  @$_SESSION['akademik'] ){ ?>
           <li><a href="?page=matkul" class=""><i class="lnr lnr-book"></i> <span>Matkul</span></a></li>
            <?php
             }?>
             <?php
             if(@$_SESSION['admin'] ||  @$_SESSION['akademik']){ ?>
