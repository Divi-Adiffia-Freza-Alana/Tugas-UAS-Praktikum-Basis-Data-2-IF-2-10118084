				...
				<div class="container-fluid">
					...
					<!-- <div class="panel panel-headline">
						<div class="panel-heading">
										...
										<?php
											if(@$_POST['tambah']) {
												...
												if(@$_POST['tambah']) {
													...
													echo "<script>alert('Tambah data pengguna gagal!')</script>";
												}
											}
										?>
							...
							<!-- end model pop up edit data pengguna -->
